...
from rebel_nerf.semantic_sdf.vol_sdf.vol_sdf_field import VolSDFField, VolSDFFieldConfig


@dataclass
class SemanticSDFFieldConfig(VolSDFFieldConfig):
...
class SemanticSDFField(VolSDFField):
    """
